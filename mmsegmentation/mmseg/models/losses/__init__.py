...
from .accuracy import Accuracy, accuracy, MultiClassAccuracy, multi_class_accuracy
...
__all__ = [
    'accuracy', 'Accuracy', 'cross_entropy', 'binary_cross_entropy', 'multi_class_accuracy', 'MultiClassAccuracy',
